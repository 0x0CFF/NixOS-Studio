{ config, pkgs, inputs, ... }:let
  ...
  bottomPath = "${config.home.homeDirectory}/Solution/Profiles/NixOS-Studio/NixOS-Flake/Modules/Crates/Operations/Terminal/Dotfiles/Bottom";
  naviPath = "${config.home.homeDirectory}/Solution/Profiles/NixOS-Studio/NixOS-Flake/Modules/Crates/Operations/Terminal/Dotfiles/Navi";
  zellijPath = "${config.home.homeDirectory}/Solution/Profiles/NixOS-Studio/NixOS-Flake/Modules/Crates/Operations/Terminal/Dotfiles/Zellij";
in
{
