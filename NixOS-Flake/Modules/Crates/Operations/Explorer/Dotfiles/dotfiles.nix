{ config, pkgs, inputs, ... }:let
  ...
  helixPath = "${config.home.homeDirectory}/Solution/Profiles/NixOS-Studio/NixOS-Flake/Modules/Crates/Operations/Terminal/Dotfiles/Helix";
  yaziPath = "${config.home.homeDirectory}/Solution/Profiles/NixOS-Studio/NixOS-Flake/Modules/Crates/Operations/Terminal/Dotfiles/Yazi";
in
{
