{ config, pkgs, inputs, ... }:let
  ...
  helixPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Studio/NixOS-Flake/Modules/Crates/Terminal/Explorer/Dotfiles/Helix";
  yaziPath = "${config.home.homeDirectory}/Solution/Blueprints/NixOS/NixOS-Studio/NixOS-Flake/Modules/Crates/Terminal/Explorer/Dotfiles/Yazi";
in
{
