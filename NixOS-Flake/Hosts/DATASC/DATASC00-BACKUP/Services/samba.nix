...

{
  ...
  services.samba = {
    settings = {
      ...
      #   "vaild users" = "@PUBLIC";
      #   # 设置可对文件进行写操作的用户、用户组
      #   "write list" = "VIDEO_R4, VIDEO_R5";
      #   # 强制用户或者组所有权，如果设置此项，则所有文件都将以此用户、用户组身份写入
      #   # "force user" = "VIDEO_R5";
      #   "force group" = "VIDEO";
      # };
      # "建模素材库(DATASC00-BACKUP#05)" = {
      ...
      #   "vaild users" = "@PUBLIC";
      #   # 设置可对文件进行写操作的用户、用户组
      #   "write list" = "ANIMATION_R4, ANIMATION_R5";
      #   # 强制用户或者组所有权，如果设置此项，则所有文件都将以此用户、用户组身份写入
      #   # "force user" = "ANIMATION_R5";
      #   "force group" = "ANIMATION";
      # };
      # "特效素材库(DATASC00-BACKUP#07)" = {
