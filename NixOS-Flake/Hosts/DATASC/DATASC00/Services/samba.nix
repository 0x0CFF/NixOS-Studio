...

{
  ...
  services.samba = {
    settings = {
      ...
      # };
      # "财务素材库" = {
      #   "path" = "/mnt/Material#FINANCE";            # 共享目录
      #   "read only" = "no";                         # 是否只读
      #   "browseable" = "yes";                       # 指定该共享是否可以浏览
      #   "writable" = "yes";                         # 指定该共享路径是否可写
      #   "public" = "no";                            # 指定该共享是否允许 Guest 账户访问
      ...
      # };
      # "商务素材库" = {
      #   "path" = "/mnt/Material#BUSINESS";          # 共享目录
      #   "read only" = "no";                         # 是否只读
      #   "browseable" = "yes";                       # 指定该共享是否可以浏览
      #   "writable" = "yes";                         # 指定该共享路径是否可写
      #   "public" = "no";                            # 指定该共享是否允许 Guest 账户访问
      ...
      # };
      # "动画素材库" = {
      #   "path" = "/mnt/Material#ANIMATION";            # 共享目录
      #   "read only" = "no";                         # 是否只读
      #   "browseable" = "yes";                       # 指定该共享是否可以浏览
      #   "writable" = "yes";                         # 指定该共享路径是否可写
      #   "public" = "no";                            # 指定该共享是否允许 Guest 账户访问
